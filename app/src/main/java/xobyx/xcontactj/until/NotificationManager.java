...
import xobyx.xcontactj.common.utils.ImageUtils;
import xobyx.xcontactj.data.Contact;
import xobyx.xcontactj.data.ContactHelper;
...
public class NotificationManager {
    ...
    public static final String ACTION_MARK_READ = "xobyx.xcontactj.MARK_READ";
    public static final String ACTION_MARK_SEEN = "xobyx.xcontactj.MARK_SEEN";
        ...
        if (sPrefs.getBoolean(SettingsFragment.NOTIFICATIONS, true)) {
            sHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (message.getThreadId() == XStartActivity.sThreadShowing) {
                        message.markRead();
                        return;
                    }
