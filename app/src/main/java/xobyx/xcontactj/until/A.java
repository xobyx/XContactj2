...
public class A implements ReportSender {
     ...
     */
    public A(@NonNull ACRAConfiguration config, @NonNull HttpSender.Method method, @NonNull HttpSender.Type type, @Nullable Map<ReportField, String> mapping) {
     ...
     *            mapping.get(ReportField.SOME_FIELD);
     */
    public A(@NonNull ACRAConfiguration config, @NonNull HttpSender.Method method, @NonNull HttpSender.Type type, @Nullable String formUri, @Nullable Map<ReportField, String> mapping) {
        this.config = config;
        mMethod = method;
