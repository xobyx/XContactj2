...
import xobyx.xcontactj.common.utils.Units;
...
import xobyx.xcontactj.ui.messagelist.MessageListFragment;
import xobyx.xcontactj.ui.popup.QKReplyActivity;
import xobyx.xcontactj.ui.search.SearchFragment;
...
public class MainActivity extends QKActivity implements SlidingMenu.SlidingMenuListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        android.support.v4.app.FragmentTransaction menuTransaction = fm.beginTransaction();
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if (!mSlidingMenu.isMenuShowing()) {
                Fragment category = getSupportFragmentManager().findFragmentByTag(SettingsFragment.CATEGORY_TAG);
                if (category != null) {
