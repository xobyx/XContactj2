...
import xobyx.xcontactj.common.utils.TextUtils;
...
public class QKTextView extends TextView {
    ...
    public void setType(int type) {
        ...
        if (mType == FontManager.TEXT_TYPE_CATEGORY) {
            LiveViewManager.registerView(QKPreference.THEME, this, new LiveView() {
                ...
                public void refresh(String key) {
                    QKTextView.this.setTextColor(FontManager.getTextColor(mContext, mType));
                }
            });
        }
        ...
        LiveViewManager.registerView(new LiveView() {
            ...
            public void refresh(String key) {
              ...
              //  int fontWeight = FontManager.getFontWeight(mContext, FontManager.getIsFontHeavy(mType));
               // QKTextView.this.setTypeface(TypefaceManager.obtainTypeface(mContext, fontFamily, fontWeight));
            }
        ...
        LiveViewManager.registerView(QKPreference.FONT_SIZE, this, new LiveView() {
            @Override
            public void refresh(String key) {
                QKTextView.this.setTextSize(TypedValue.COMPLEX_UNIT_SP, FontManager.getTextSize(mContext, mType));
            }
        });
        ...
        LiveViewManager.registerView(QKPreference.TEXT_FORMATTING, this, new LiveView() {
            @Override
            public void refresh(String key) {
                QKTextView.this.setText(getText(), BufferType.NORMAL);
            }
        });
    }
