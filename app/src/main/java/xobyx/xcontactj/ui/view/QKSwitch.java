    ...
    private void init(Context context) {
        ...
        LiveViewManager.registerView(new LiveView() {
            ...
            public void refresh(String key) {
                DrawableCompat.setTintList(QKSwitch.this.getThumbDrawable(), QKSwitch.this.getSwitchThumbColorStateList());
                DrawableCompat.setTintList(QKSwitch.this.getTrackDrawable(), QKSwitch.this.getSwitchTrackColorStateList());
            }
