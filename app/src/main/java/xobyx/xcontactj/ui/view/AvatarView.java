...
public class AvatarView extends ImageView implements View.OnClickListener {
        ...
        if (!isInEditMode()) {
            ...
            LiveViewManager.registerView(xobyx.xcontactj.enums.QKPreference.THEME, this, new LiveView() {
                ...
                public void refresh(String key) {
                    ...
                    if (AvatarView.this.getBackground() == null) {
                        AvatarView.this.setBackgroundResource(R.drawable.circle);
                    }
                    AvatarView.this.getBackground().setColorFilter(ThemeManager.getColor(), PorterDuff.Mode.SRC_ATOP);
                }
            });
        }
    }
     ...
     * photo.
     *
     * @param contactUri Either a {@link ContactsContract.Contacts#CONTENT_URI} or
     *                   {@link ContactsContract.Contacts#CONTENT_LOOKUP_URI} style URI.
     */
