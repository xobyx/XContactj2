...
import xobyx.xcontactj.common.formatter.FormatterFactory;
...
import xobyx.xcontactj.common.utils.AddressUtils;
...
public class MessageItem {
    ...
    public MessageItem(Context context, String type, final Cursor cursor,
        ...
        if ("sms".equals(type)) {
            ...
            mItemLoadedFuture = MyApp.getApplication().getPduLoaderManager()
