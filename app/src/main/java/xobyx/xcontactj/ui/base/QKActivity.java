...
public abstract class QKActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LiveViewManager.registerView(QKPreference.TINTED_STATUS, this, new LiveView() {
            @Override
            public void refresh(String key) {
                mStatusTintEnabled = QKActivity.this.getBoolean(QKPreference.TINTED_STATUS) &&
                        Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP;
            }
        });

        LiveViewManager.registerView(QKPreference.TINTED_NAV, this, new LiveView() {
            @Override
            public void refresh(String key) {
                mNavigationTintEnabled = QKActivity.this.getBoolean(QKPreference.TINTED_NAV) &&
                        Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP;
            }
        });
    }
        ...
        LiveViewManager.registerView(QKPreference.THEME, this, new LiveView() {
            ...
            public void refresh(String key) {
                ...
                if (mStatusTintEnabled) {
                    QKActivity.this.getWindow().setStatusBarColor(ColorUtils.darken(ThemeManager.getColor()));
                }
                if (mNavigationTintEnabled) {
                    QKActivity.this.getWindow().setNavigationBarColor(ColorUtils.darken(ThemeManager.getColor()));
                }
            }
        });
    ...
    /*public RequestQueue getRequestQueue() {
        return ((MyApp) getApplication()).getRequestQueue();
    }*/
