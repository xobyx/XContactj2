...
import xobyx.xcontactj.ui.view.QKRingtonePreference;
import xobyx.xcontactj.ui.view.QKSwitchPreference;
    ...
    public boolean onPreferenceClick(Preference preference) {
        switch (preference.getKey()) {
            ...
            case SettingsFragment.NOTIFICATION_LED_COLOR:
                ...
                ledColorPickerDialog.setOnColorSelectedListener(new ColorPickerSwatch.OnColorSelectedListener() {
                    @Override
