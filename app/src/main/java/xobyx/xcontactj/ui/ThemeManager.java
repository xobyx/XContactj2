...
import xobyx.xcontactj.common.utils.ColorUtils;
import xobyx.xcontactj.enums.QKPreference;
import xobyx.xcontactj.receiver.IconColorReceiver;
...
public class ThemeManager {
                    ...
                    public void onClick(View v) {
                        ...
                        for (int i = 0; i < colors.length; i++) {
                            String componentClassName = String.format(
                                    "xobyx.xcontactj.ui.MainActivity-%s", colors[i]
                            );
    ...
    public static void showColorPickerDialog(final QKActivity context) {
        ...
        final ColorPickerPalette palette = new ColorPickerPalette(context);
        palette.setGravity(Gravity.CENTER);
        palette.init(19, 4, new ColorPickerSwatch.OnColorSelectedListener() {
            @Override
            public void onColorSelected(int color) {
                palette.init(getSwatch(color).length, 4, new ColorPickerSwatch.OnColorSelectedListener() {
                    @Override
    ...
    public static void showColorPickerDialogForConversation(final QKActivity context, final ConversationPrefsHelper prefs) {
        final QKDialog dialog = new QKDialog();
    ...
    public static void setStatusBarTintEnabled(final QKActivity activity, boolean enabled) {
    ...
    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public static void setNavigationBarTintEnabled(final QKActivity activity, boolean enabled) {
        int colorFrom = enabled ? mResources.getColor(R.color.black) : mColor;
        int colorTo = enabled ? mColor : mResources.getColor(R.color.black);
    ...
    public static void setColor(final QKActivity activity, int color) {
