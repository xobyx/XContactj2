...
/**
 * A subclass of {@link xobyx.xcontactj.me.CompositeCursorAdapter} that manages pinned partition headers.
 */
public abstract class PinnedHeaderListAdapter extends xobyx.xcontactj.me.CompositeCursorAdapter
        implements xobyx.xcontactj.me.PinnedHeaderListView.PinnedHeaderAdapter {
    ...
    @Override
    public void configurePinnedHeaders(xobyx.xcontactj.me.PinnedHeaderListView listView) {
