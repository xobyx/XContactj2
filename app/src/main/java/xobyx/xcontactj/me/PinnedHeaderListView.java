 ...
 */
public class PinnedHeaderListView extends xobyx.xcontactj.me.AutoScrollListView
  ...
  //  ;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mHeaderPaddingStart =SDK_INT>=17? getPaddingStart():0;
        final int end = SDK_INT>=17? getPaddingEnd():0;
        mHeaderWidth = r - l - mHeaderPaddingStart - end;
    }
