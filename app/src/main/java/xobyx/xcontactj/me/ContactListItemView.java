...
public class ContactListItemView extends ViewGroup
    ...
    private int mPreferredHeight = 100;
    ...
    private int mNameTextViewTextSize = 15;
    ...
    private int mPhotoPosition = getDefaultPhotoPosition(false /* normal/non opposite */);
    // Header layout data
    private TextView mHeaderTextView;
    private boolean mIsSectionHeaderEnabled;
    // The views inside the contact view
    //FIXME:i change this
    private boolean mQuickContactEnabled = false;
    ...
    public ContactListItemView(Context context) {
        ...
        mTextHighlighter = new TextHighlighter(Typeface.BOLD, 0x980084ff);
    ...
    public ContactListItemView(Context context, AttributeSet attrs) {
        ...
        mSecondaryTextColor = new ColorStateList(states, colors);
        //  a.recycle();
        ...
        //todo: setLayoutDirection(View.LAYOUT_DIRECTION_LOCALE);
    }

    static public final int getDefaultPhotoPosition(boolean opposite) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (isVisible(mLabelView)) {
            ...
            final int mode = (mPhotoPosition == LEFT
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        final boolean isLayoutRtl = SDK_INT >= 20 && ViewUtil.isViewLayoutRtl(this);
        ...
        final View photoView = mPhotoView;
        if (mPhotoPosition == LEFT) {
        ...
        if (!TextUtils.isEmpty(title)) {
            if (mHeaderTextView == null) {
                ...
                mHeaderTextView.setGravity(
                        SDK_INT>=20&&ViewUtil.isViewLayoutRtl(this) ? Gravity.RIGHT : Gravity.LEFT);
    ...
    public TextView getNameTextView() {
        if (mNameTextView == null) {
            ...
            if (m == null) {
                m = Typeface.createFromAsset(getContext().getAssets(), "bein.ttf");
            }
            mNameTextView.setTypeface(m);
...
if(SDK_INT>=21) {
   ...
   // @TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR1)
    ...
    //get Row From Cursor Parameters cursor..
    ...
    public void showPresenceAndStatusMessage(Cursor cursor, int presenceColumnIndex,
        ...
        if (!cursor.isNull(presenceColumnIndex)) {
            ...
            Drawable f = new ColorDrawable(0x00ff00);
            icon = f;//ContactPresenceIconUtil.getPresenceIcon(getContext(), presence);
        }
        setPresence(icon);
        ...
        if (statusMessage == null && presence != 0) {
            //TODO:eee
            statusMessage = "Statut";//ContactStatusUtil.getStatusString(getContext(), presence);
        }
    ...
    public static class ContactDisplayUtils {
        ...
        public static Spannable getTelephoneTtsSpannable(String phoneNumber) {
            ...
            spannable.setSpan(new StyleSpan(Typeface.BOLD), 0, phoneNumber.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            return spannable;
        }
