...
package xobyx.xcontactj.mmssms;
...
import xobyx.xcontactj.until.Message;
import xobyx.xcontactj.until.Settings;
...
public class Transaction {
    ...
    public static final String MMS_ERROR = "xobyx.xcontactj.send_message.MMS_ERROR";
    public static final String REFRESH = "xobyx.xcontactj.send_message.REFRESH";
    public static final String MMS_PROGRESS = "xobyx.xcontactj.send_message.MMS_PROGRESS";
    public static final String VOICE_FAILED = "xobyx.xcontactj.send_message.VOICE_FAILED";
    public static final String VOICE_TOKEN = "xobyx.xcontactj.send_message.RNRSE";
    public static final String NOTIFY_OF_DELIVERY = "xobyx.xcontactj.send_message.NOTIFY_DELIVERY";
    public static final String NOTIFY_OF_MMS = "xobyx.xcontactj.messaging.NEW_MMS_DOWNLOADED";
