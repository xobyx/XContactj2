...
import xobyx.xcontactj.common.google.ItemLoadedFuture;
...
public class ImageModel extends RegionMediaModel {
    ...
    public ImageModel(Context context, Uri uri, RegionModel region)
            throws MmsException, MediaDrmException {
    ...
    protected void checkContentRestriction() throws MediaDrmException {
    ...
    private class ExceedMessageSizeException extends MmsException {
        public ExceedMessageSizeException(String s) {
        }
    }
}
