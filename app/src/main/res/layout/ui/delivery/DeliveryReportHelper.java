...
import xobyx.xcontactj.ui.delivery.*;
...
public class DeliveryReportHelper {
    ...
    public List<xobyx.xcontactj.ui.delivery.DeliveryReportItem> getListItems() {
        List<xobyx.xcontactj.ui.delivery.DeliveryReportItem> items = getReportItems();
        if (items == null) {
            items = new ArrayList<>(1);
            items.add(new xobyx.xcontactj.ui.delivery.DeliveryReportItem("", mContext.getString(R.string.status_none), null));
            Log.w(LOG_TAG, "cursor == null");
        }
        return items;
    }

    private List<xobyx.xcontactj.ui.delivery.DeliveryReportItem> getReportItems() {
    ...
    private List<xobyx.xcontactj.ui.delivery.DeliveryReportItem> getSmsReportItems() {
        ...
        try {
            ...
            List<xobyx.xcontactj.ui.delivery.DeliveryReportItem> items = new ArrayList<>();
            while (c.moveToNext()) {
                ...
                items.add(new xobyx.xcontactj.ui.delivery.DeliveryReportItem(
    ...
    private List<xobyx.xcontactj.ui.delivery.DeliveryReportItem> getMmsReportItems() {
