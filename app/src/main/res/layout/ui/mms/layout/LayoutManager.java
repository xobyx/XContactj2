...
package layout.ui.mms.layout;

import android.content.Context;
import android.content.res.Configuration;
import android.util.Log;

import xobyx.xcontactj.ui.mms.layout.HVGALayoutParameters;
import xobyx.xcontactj.ui.mms.layout.LayoutParameters;
...
public class LayoutManager {
    ...
    private static xobyx.xcontactj.ui.mms.layout.LayoutManager sInstance;
    ...
    public static void init(Context context) {
        ...
        sInstance = new xobyx.xcontactj.ui.mms.layout.LayoutManager(context);
    }

    public static xobyx.xcontactj.ui.mms.layout.LayoutManager getInstance() {
        if (sInstance == null) {
