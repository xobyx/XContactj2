...
public class MMSDialogFragment extends DialogFragment {
    ...
    xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setListener(T l) {
        mListener = l;
    ...
    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setContext(Context context) {
        mContext = context;
        mResources = context.getResources();
        return this;
    }

    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setTitle(int resource) {
        return setTitle(mResources.getString(resource));
    }

    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setTitle(String title) {
        mTitleEnabled = true;
        mTitleText = title;
        return this;
    }

    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setMessage(int resource) {
        return setMessage(mResources.getString(resource));
    }

    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setMessage(String message) {
        mMessageEnabled = true;
        mMessageText = message;
        return this;
    }

    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setCancelOnTouchOutside(boolean cancelable) {
        setCancelable(cancelable);
        return this;
    }

    // TODO fix stack from bottom issue
    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setButtonBarOrientation(int orientation) {
        mButtonBarOrientation = orientation;
        return this;
    }

    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setCustomView(View view) {
        mCustomViewEnabled = true;
        mCustomView = view;
        return this;
    }

    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setItems(int resource, final int resultCode) {
        return setItems(mResources.getStringArray(resource));
    }

    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setItems(String[] items) {
    ...
    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setDoubleLineItems(int titles, int bodies) {
        return setDoubleLineItems(
                mResources.getStringArray(titles), mResources.getStringArray(bodies)
        );
    }

    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setDoubleLineItems(String[] titles, String[] bodies) {
    ...
    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setTripleLineItems(int titles, int subtitles, int bodies) {
    ...
    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setTripleLineItems(String[] titles, String[] subtitles,
                                                String[] bodies) {
    ...
    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setPositiveButton(int resource) {
        return setPositiveButton(mResources.getString(resource));
    }

    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setPositiveButton(String text) {
        mPositiveButtonEnabled = true;
        mPositiveButtonText = text;
        return this;
    }

    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setNeutralButton(int resource) {
        return setNeutralButton(mResources.getString(resource));
    }

    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setNeutralButton(String text) {
        mNeutralButtonEnabled = true;
        mNeutralButtonText = text;
        return this;
    }

    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setNegativeButton(int resource) {
        return setNegativeButton(mResources.getString(resource));
    }

    public xobyx.xcontactj.ui.dialog.mms.MMSDialogFragment setNegativeButton(String text) {
