...
import xobyx.xcontactj.ui.dialog.*;
...
public class ConversationSettingsDialog extends QKDialog implements Preference.OnPreferenceClickListener {
    ...
    public static xobyx.xcontactj.ui.dialog.ConversationSettingsDialog newInstance(long threadId, String name) {
        xobyx.xcontactj.ui.dialog.ConversationSettingsDialog dialog = new xobyx.xcontactj.ui.dialog.ConversationSettingsDialog();
