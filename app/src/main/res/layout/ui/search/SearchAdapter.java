...
import xobyx.xcontactj.ui.search.*;
import xobyx.xcontactj.ui.search.SearchData;

public class SearchAdapter extends RecyclerCursorAdapter<SearchViewHolder, xobyx.xcontactj.ui.search.SearchData> {
    ...
    @Override
    protected xobyx.xcontactj.ui.search.SearchData getItem(int position) {
        mCursor.moveToPosition(position);
        return new xobyx.xcontactj.ui.search.SearchData(mCursor);
    }
