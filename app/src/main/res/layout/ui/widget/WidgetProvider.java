...
import xobyx.xcontactj.ui.widget.*;
import xobyx.xcontactj.ui.widget.WidgetService;
...
public class WidgetProvider extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ACTION_NOTIFY_DATASET_CHANGED.equals(action)) {
            ...
            int[] appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(context, xobyx.xcontactj.ui.widget.WidgetProvider.class));
