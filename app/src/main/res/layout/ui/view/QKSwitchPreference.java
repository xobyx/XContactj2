...
import xobyx.xcontactj.ui.view.QKSwitch;
...
public class QKSwitchPreference extends SwitchPreference {
    ...
    private xobyx.xcontactj.ui.view.QKSwitch mCheckBox;
    ...
    public View getView(View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(v -> {
            ...
            if (mOnPreferenceClickListener != null) {
                mOnPreferenceClickListener.onPreferenceClick(xobyx.xcontactj.ui.view.QKSwitchPreference.this);
            }
        });
