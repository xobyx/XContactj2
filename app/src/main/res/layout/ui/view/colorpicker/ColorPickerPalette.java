...
public class ColorPickerPalette extends TableLayout {
    ...
    public layout.ui.view.colorpicker.ColorPickerSwatch.OnColorSelectedListener mOnColorSelectedListener;
    ...
    private layout.ui.view.colorpicker.ColorPickerSwatch createColorSwatch(int color, int selectedColor) {
        layout.ui.view.colorpicker.ColorPickerSwatch colorPickerSwatch = new layout.ui.view.colorpicker.ColorPickerSwatch(getContext(), color, color == selectedColor, mOnColorSelectedListener);
        TableRow.LayoutParams layoutParams = new TableRow.LayoutParams(mSwatchLength, mSwatchLength);
        layoutParams.setMargins(mMarginSize, mMarginSize, mMarginSize, mMarginSize);
    ...
    public void init(int size, int numColumns, layout.ui.view.colorpicker.ColorPickerSwatch.OnColorSelectedListener onColorSelectedListener) {
