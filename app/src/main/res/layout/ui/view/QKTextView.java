...
import xobyx.xcontactj.ui.view.*;
import xobyx.xcontactj.ui.view.QKPreference;
...
public class QKTextView extends TextView {
    ...
    public void setType(int type) {
        ...
        if (mType == FontManager.TEXT_TYPE_CATEGORY) {
            LiveViewManager.registerView(xobyx.xcontactj.ui.view.QKPreference.THEME, this, key ->
                    setTextColor(FontManager.getTextColor(mContext, mType)));
        }
        ...
        }, xobyx.xcontactj.ui.view.QKPreference.FONT_FAMILY, xobyx.xcontactj.ui.view.QKPreference.FONT_WEIGHT);

        LiveViewManager.registerView(xobyx.xcontactj.ui.view.QKPreference.FONT_SIZE, this, key -> {
            setTextSize(TypedValue.COMPLEX_UNIT_SP, FontManager.getTextSize(mContext, mType));
        });

        LiveViewManager.registerView(xobyx.xcontactj.ui.view.QKPreference.BACKGROUND, this, key -> {
            setTextColor(FontManager.getTextColor(mContext, mType));
        });
