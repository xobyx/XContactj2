...
import xobyx.xcontactj.ui.settings.*;
import xobyx.xcontactj.ui.settings.TimePickerFragment;
...
public class SettingsFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener,
    ...
    public static xobyx.xcontactj.ui.settings.SettingsFragment newInstance(int category) {
        xobyx.xcontactj.ui.settings.SettingsFragment fragment = new xobyx.xcontactj.ui.settings.SettingsFragment();
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        if (resId != 0) {
            Fragment fragment = xobyx.xcontactj.ui.settings.SettingsFragment.newInstance(resId);
            getFragmentManager()
                    .beginTransaction()
        ...
        switch (key) {
            ...
            case DAY_START:
            case NIGHT_START:
                xobyx.xcontactj.ui.settings.TimePickerFragment fragment = new TimePickerFragment();
    ...
    public void showQkResponseEditor() {
        ...
        Set<String> responseSet = mPrefs.getStringSet(xobyx.xcontactj.ui.settings.SettingsFragment.QK_RESPONSES, defaultResponses);
        ...
        new QKDialog()
                ...
                .setPositiveButton(R.string.save, new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        mPrefs.edit().putStringSet(xobyx.xcontactj.ui.settings.SettingsFragment.QK_RESPONSES, new HashSet<>(adapter.getResponses())).apply();
                    }
                })
                .setNegativeButton(R.string.cancel, null)
