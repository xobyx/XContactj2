...
public  class QKResponseAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final xobyx.xcontactj.ui.settings.ViewHolder vh;

        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.list_item_qk_response, null);

            vh = new xobyx.xcontactj.ui.settings.ViewHolder();
            ...
            vh = (xobyx.xcontactj.ui.settings.ViewHolder) convertView.getTag();
        }
