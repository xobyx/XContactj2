...
public class MessageItem {
    ...
    public xobyx.xcontactj.ui.messagelist.MessageColumns.ColumnsMap mColumnsMap;
    ...
    public class PduLoadedMessageItemCallback implements ItemLoadedCallback {
        public void onItemLoaded(Object result, Throwable exception) {
            ...
            if (mPduLoadedCallback != null) {
                mPduLoadedCallback.onPduLoaded(xobyx.xcontactj.ui.messagelist.MessageItem.this);
            }
        }
    }
    ...
    public interface PduLoadedCallback {
         ...
         */
        void onPduLoaded(xobyx.xcontactj.ui.messagelist.MessageItem messageItem);
    }
