...
public class MessageItemCache extends LruCache<Long, MessageItem> {
    ...
    private layout.ui.messagelist.MessageColumns.ColumnsMap mColumnsMap;
    private Pattern mSearchHighlighter;

    public MessageItemCache(Context context, layout.ui.messagelist.MessageColumns.ColumnsMap columnsMap, Pattern searchHighlighter, int maxSize) {
        super(maxSize);
